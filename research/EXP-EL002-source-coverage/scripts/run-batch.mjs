...
const manifestLocation = manifestArgument
  ...
  : new URL("../batch-01.manifest.json", import.meta.url);
...
if (manifest.experiment !== "EXP-EL002" || manifest.partition !== "CARDIOVASCULAR_01" ||
...
async function executeCase(testCase) {
  ...
  const input = {
    ...
    evidenceSpans: [span],
    reviewContext: {
      domain: "cardiovascular-source-coverage",
